          ...
          <ul className="list-unstyled mt-3 mb-0">
            {description.map((item, idx) => (
              <li
                ...
                style={{
                  animation: isActive
                    ? `fadeIn 0.3s ease forwards ${0.1 + idx * 0.1}s`
                    : "none",
                  opacity: 0,
                }}
              >
...
const TRGProductionsPage = () => {
  ...
  const SectionHeader = ({ title, subtitle }) => (
    <div className="text-center mb-5 position-relative">
      ...
      <p className="fs-5 text-white-50 mt-3">{subtitle}</p>
    </div>
  );
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(255,0,85,0.1) 0%, rgba(255,0,85,0) 70%)",
            zIndex: 0,
          }}
        />
          ...
          <div className="row align-items-center">
            <div className="col-lg-8 mx-auto text-center">
              ...
              <p className="fs-5 mb-4 text-white-50">
                Let's transform your ideas into compelling visual stories that
